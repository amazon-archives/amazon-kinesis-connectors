...
public class KinesisMessageModelRedshiftTransformer extends RedshiftTransformer<KinesisMessageModel> {
    ...
    public String toDelimitedString(KinesisMessageModel record) {
        ...
        b.append(record.userid).append(delim).append(record.username).append(delim).append(record.firstname)
                .append(delim).append(record.lastname).append(delim).append(record.city).append(delim)
                .append(record.state).append(delim).append(record.email).append(delim).append(record.phone)
                .append(delim).append(record.likesports).append(delim).append(record.liketheatre)
                .append(delim).append(record.likeconcerts).append(delim).append(record.likejazz)
                .append(delim).append(record.likeclassical).append(delim).append(record.likeopera)
                .append(delim).append(record.likerock).append(delim).append(record.likevegas).append(delim)
                .append(record.likebroadway).append(delim).append(record.likemusicals).append("\n");
